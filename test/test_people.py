...
from createsend.createsend import Person
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(person.EmailAddress, email)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(person.Name, "Person One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(person.AccessLevel, 1023)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(person.Status, "Active")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(result.EmailAddress, "person@example.com")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(self.person.email_address, new_email)
