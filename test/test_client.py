...
from createsend.createsend import Client
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals("32a381c49a2df99f1d0c6f3c112352b9", client_id)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals("32a381c49a2df99f1d0c6f3c112352b9", c.client_id)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(cl.BasicDetails.ClientID,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(cl.BasicDetails.ContactName, "Client One (contact)")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(cl.AccessDetails.Username, "clientone")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(cl.AccessDetails.AccessLevel, 23)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].WebVersionURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].WebVersionTextURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].Subject, 'Campaign One')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].Name, 'Campaign One')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].SentDate, '2010-10-12 12:58:00')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].TotalRecipients, 2245)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(len(campaigns), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].DateScheduled, "2011-05-25 10:40:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].ScheduledTimeZone,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].Name, "Magic Issue One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].Subject, "Magic Issue One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].DateCreated, "2011-05-24 10:37:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].PreviewURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(campaigns[0].PreviewTextURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(len(drafts), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].CampaignID,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].Name, 'Draft One')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].Subject, 'Draft One')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].DateCreated, '2010-08-19 16:08:00')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].PreviewURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(drafts[0].PreviewTextURL,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(len(lists), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].ListID, 'a58ee1d3039b8bec838e6d1482a8a965')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].Name, 'List One')
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(len(lists), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].ListID, 'ab4a2b57c7c8f1ba62f898a1af1a575b')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].ListName, 'List Number One')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].SubscriberState, 'Active')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(lists[0].DateSubscriberAdded, '2012-08-20 22:32:00')
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(res.Results[0].SuppressionReason, "Unsubscribed")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(res.Results[0].EmailAddress, "example+1@example.com")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(res.Results[0].Date, "2010-10-26 10:55:31")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(res.Results[0].State, "Suppressed")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(len(templates), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(templates[0].TemplateID,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(templates[0].Name, 'Template One')
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(result.AccountCredits, 800)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(result.ClientCredits, 200)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(2, len(people))
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals('person1@blackhole.com', people[0].EmailAddress)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals('Person One', people[0].Name)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals('Active', people[0].Status)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals('person@blackhole.com', primary_contact.EmailAddress)
