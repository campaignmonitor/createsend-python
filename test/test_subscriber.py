...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.EmailAddress, email)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.Name, "Subscriber One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.Date, "2010-10-25 10:28:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.ListJoinedDate, "2010-10-25 10:28:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.State, "Active")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(subscriber.CustomFields), 3)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.CustomFields[0].Key, 'website')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.CustomFields[
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.ReadsEmailWith, "Gmail")
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***0].Value, 'http://example.com')
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.ReadsEmailWith, "Gmail")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(subscriber.ConsentToTrack, "Yes")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(email_address, "subscriber@example.com")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(self.subscriber.email_address, new_email)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(import_result.FailureDetails), 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalUniqueEmailsSubmitted, 3)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalExistingSubscribers, 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalNewSubscribers, 3)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(import_result.DuplicateEmailsInSubmission), 0)
...
***REMOVED******REMOVED******REMOVED******REMOVED***import_result = self.subscriber.import_subscribers(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***self.list_id, subscribers, True)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(import_result.FailureDetails), 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.FailureDetails[
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.FailureDetails[0].Code, 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.FailureDetails[
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalUniqueEmailsSubmitted, 3)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalExistingSubscribers, 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(import_result.TotalNewSubscribers, 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(import_result.DuplicateEmailsInSubmission), 0)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.subscriber.stub_request("subscribers/{}/history.json?email={}".format(
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(history), 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Name, "Campaign One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Type, "Campaign")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].ID, "fc0ce7105baeaf97f47c99be31d02a91")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(history[0].Actions), 6)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Actions[0].Event, "Open")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Actions[0].Date, "2010-10-12 13:18:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Actions[0].IPAddress, "192.168.126.87")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(history[0].Actions[0].Detail, "")
