...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(list_id, "e3c5f034d68744f7881fdccf13c2daee1234")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(l.list_id, "e3c5f034d68744f7881fdccf13c2daee1234")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(personalisation_tag, "[newdatefield]")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(personalisation_tag, "[myrenamedcustomfield]")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(details.ConfirmedOptIn, False)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(details.Title, "a non-basic list :)")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(details.UnsubscribePage, "")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(details.ListID, "2fe4c8f0373ce320e2200596d7ef168f")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(details.ConfirmationSuccessPage, "")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(cfs), 3)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].FieldName, "website")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].Key, "[website]")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].DataType, "Text")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].FieldOptions, [])
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].VisibleInPreferenceCenter, True)
...
***REMOVED******REMOVED******REMOVED******REMOVED***cfs = self.list.custom_fields()
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(cfs), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].FieldName, "salary_range")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(cfs[0].FieldOptions, [
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***"£0-20k", "£20-30k", "£30k+"])
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(stats.TotalActiveSubscribers, 6)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(stats.TotalUnsubscribes, 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(stats.TotalDeleted, 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(stats.TotalBounces, 0)
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Date, "2010-10-25 10:28:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ListJoinedDate, "2010-10-24 10:28:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].State, "Active")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(res.Results[0].CustomFields), 5)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].CustomFields[0].Key, "website")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].CustomFields[1].Value, "option one")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].CustomFields[
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].CustomFields[2].Value, "option two")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ReadsEmailWith, "Gmail")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].EmailAddress,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***"subs+7t8787Y@example.com")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Name, "Unconfirmed One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].State, "Unconfirmed")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Name, "Unsub One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Date, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ListJoinedDate, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].State, "Unsubscribed")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(res.Results[0].CustomFields), 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ReadsEmailWith, "Gmail")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***res.Results[0].EmailAddress, "subscriber@example.com")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Name, "Deleted One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Date, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ListJoinedDate, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].State, "Deleted")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(res.Results[0].CustomFields), 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ReadsEmailWith, "Gmail")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.PageNumber, 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.PageSize, 1000)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.RecordsOnThisPage, 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.TotalNumberOfRecords, 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.NumberOfPages, 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(res.Results), 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].EmailAddress,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Name, "Bounced One")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].Date, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ListJoinedDate, "2010-10-25 13:11:00")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].State, "Bounced")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(res.Results[0].CustomFields), 0)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(res.Results[0].ReadsEmailWith, "")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(hooks), 2)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(hooks[0].WebhookID, "943678317049bc13")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(len(hooks[0].Events), 1)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(hooks[0].Events[0], "Deactivate")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(hooks[0].Url, "http://www.postbin.org/d9w8ud9wud9w")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(hooks[0].Status, "Active")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(hooks[0].PayloadFormat, "Json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(webhook_id, "6a783d359bd44ef62c6ca0d3eda4412a")
