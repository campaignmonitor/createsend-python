...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request("transactional/smartEmail?status=%s" %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** status, "tx_smartemails.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***"transactional/smartEmail?status=active", "tx_smartemails.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request("transactional/smartEmail?status=all&clientID=%s" %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** self.client_id, "tx_smartemails.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request("transactional/smartEmail/%s" %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** self.smart_email_id, "tx_smartemail_details.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***"transactional/classicEmail/groups", "tx_classicemail_groups.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request("transactional/classicEmail/groups?clientID=%s" %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** self.client_id, "tx_classicemail_groups.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request("transactional/statistics",
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** "tx_statistics_classic.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request('transactional/statistics?to=%s&from=%s&clientID=%s' %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** (end, start, self.client_id), "tx_statistics_classic.json")
***REMOVED******REMOVED******REMOVED******REMOVED***stats = self.tx.statistics(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{'clientID': self.client_id, 'from': start, 'to': end})
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEqual(stats.Query.Group, "Password Reset")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request('transactional/messages?status=%s&group=%s' %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** ("all", "Password+Reset"), "tx_messages_classic.json")
***REMOVED******REMOVED******REMOVED******REMOVED***timeline = self.tx.message_timeline(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{'status': 'all', 'group': 'Password Reset'})
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request('transactional/messages?status=%s&smartEmailID=%s' %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** ("all", self.smart_email_id), "tx_messages_smart.json")
***REMOVED******REMOVED******REMOVED******REMOVED***timeline = self.tx.message_timeline(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{'status': 'all', 'smartEmailID': self.smart_email_id})
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx.stub_request('transactional/messages/%s/resend' %
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** (self.message_id), "tx_send_single.json")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.smart_email_id = '21dab350-f484-11e4-ad38-6c4008bc7468'
***REMOVED******REMOVED******REMOVED******REMOVED***self.message_id = 'ddc697c7-0788-4df3-a71a-a7cb935f00bd'
***REMOVED******REMOVED******REMOVED******REMOVED***self.before_id = 'e2e270e6-fbce-11e4-97fc-a7cf717ca157'
***REMOVED******REMOVED******REMOVED******REMOVED***self.after_id = 'e96fc6ca-fbce-11e4-949f-c3ccd6a68863'
***REMOVED******REMOVED******REMOVED******REMOVED***self.tx = Transactional(
