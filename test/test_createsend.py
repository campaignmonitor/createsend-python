...
class CreateSendTestCase:
    ...
    def test_bad_request_on_put(self):
        ...
        self.assertRaises(self.error_responses[400], template.update, "Template One Updated", "https://templates.org/index.html",
    ...
    def test_unauthorized_on_put(self):
        ...
        self.assertRaises(self.error_responses[401], template.update, "Template One Updated", "https://templates.org/index.html",
                          "https://templates.org/files.zip")
    ...
    def test_not_found_on_put(self):
        ...
        self.assertRaises(self.error_responses[404], template.update, "Template One Updated", "https://templates.org/index.html",
                          "https://templates.org/files.zip")
    ...
    def test_other_client_error_on_put(self):
        ...
        self.assertRaises(self.error_responses[418], template.update, "Template One Updated", "https://templates.org/index.html",
                          "https://templates.org/files.zip")
    ...
    def test_server_error_on_put(self):
        ...
        self.assertRaises(self.error_responses[500], template.update, "Template One Updated", "https://templates.org/index.html",
                          "https://templates.org/files.zip")
