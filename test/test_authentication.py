...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(authorize_url,
...
***REMOVED******REMOVED******REMOVED******REMOVED***)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(self.cs.faker.actual_body,
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(access_token, "SlAV32hkKG")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(expires_in, 1209600)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(refresh_token, "tGzv3JOkF0XG5Qx2TlKWIA")
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(self.cs.headers['Authorization'], "Basic %s" % base64.b64encode(
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.cs.stub_request("systemdate.json", "systemdate.json")
***REMOVED******REMOVED******REMOVED******REMOVED***systemdate = self.cs.systemdate()
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(self.cs.headers[
...
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(new_access_token, "SlAV32hkKG2e12e")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(new_expires_in, 1209600)
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(new_refresh_token, "tGzv3JOkF0XG5Qx2TlKWIA")
***REMOVED******REMOVED******REMOVED******REMOVED***self.assertEquals(self.cs.auth_details,
